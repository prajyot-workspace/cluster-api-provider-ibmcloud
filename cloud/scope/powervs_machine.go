...
func (m *PowerVSMachineScope) bucketName() string {
	...
	return fmt.Sprintf("%s-%s-%s", m.IBMPowerVSCluster.GetName(), "cosinstance", "bucket")
}

func (m *PowerVSMachineScope) bucketRegion() (string, error) {
	var region string
